...
import { getSidebarExpandedTaskStyles } from '@/lib/styling';
...
const SidebarTaskItem: React.FC<SidebarTaskItemProps> = ({
  ...
  const expandedStyles = useMemo(() => getSidebarExpandedTaskStyles(task.category), [task.category]);
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ backgroundColor: expandedStyles.accentColor }}
      />
